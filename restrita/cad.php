...
<body>
    ...
    <main>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nome'], $_POST['tipogastos'], $_POST['data'],$_POST['deposito'], $_POST['valor'], $_FILES['foto'])) {
            ...
            $sql = "INSERT INTO tabela_de_gastos (nome, tipogastos, data,deposito , valor , foto) VALUES (?, ?, ?, ?,?,?)";
            ...
            if ($stmt) {
                ...
                mysqli_stmt_bind_param($stmt, "sssssd", $nome, $tipogastos, $data, $deposito , $valor, $nome_foto);
